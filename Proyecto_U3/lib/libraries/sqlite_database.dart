  ...
  Future<Database> dbConnect() async{
    ...
    return openDatabase(
        ...
        onCreate: (db,version) async{
          ...
          //Tabla gasto
          await db.execute("CREATE TABLE gasto(idgasto INTEGER PRIMARY KEY, idusuario INTEGER NOT NULL,fecha TEXT NOT NULL, descripcion TEXT NOT NULL, acreedor_cobrador TEXT NOT NULL, medio_de_pago TEXT NOT NULL, valor TEXT null, estado TEXT NOT NULL) ");
          //Tabla ingreso
          await db.execute("CREATE TABLE ingreso(idingreso INTEGER PRIMARY KEY, idusuario INTEGER NOT NULL,fecha TEXT NOT NULL, descripcion TEXT NOT NULL, fuente_beneficiario TEXT NOT NULL, medio_de_pago TEXT NOT NULL, estado TEXT NOT NULL, valor TEXT null) ");
          //Tabla cuenta
          await db.execute("CREATE TABLE cuenta(idcuenta INTEGER PRIMARY KEY, idusuario INTEGER NOT NULL,intentos_fallidos INTEGER NOT NULL, limite_gastos_mes REAL null, limite_gastos_semana REAL null) ");
          //Tabla notificacion
